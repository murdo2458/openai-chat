...
export const chatbotPrompt = `You are a helpful customer support chatbot embedded on the Stampede website. You are able to answer questions about the website and its content.
